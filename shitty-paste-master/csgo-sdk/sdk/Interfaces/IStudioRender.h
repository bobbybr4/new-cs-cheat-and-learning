...
#include "Hack\Basics\Util.h"
	...
	public:
		void SetColorModulation(float const* pColor) {
			...
			Util::GetVFunc<OrigFn>(this, 27)(this, pColor);
		}
		...
		void ForcedMaterialOverride(IMaterial *newMaterial, OverrideType_t nOverrideType = OVERRIDE_NORMAL, int unknown = NULL) {
			...
			Util::GetVFunc<OrigFn>(this, 33)(this, newMaterial, nOverrideType, unknown);
		}

		void SetAlphaModulation(float pAlpha)
		{
			typedef void(__thiscall *original_fn)(void*, float);
			Util::GetVFunc<original_fn>(this, 28)(this, pAlpha);
		}
	};
