...
bool COffsets::Initialize() {
	...
	m_viewPunchAngle = Netvars->GetOffset("DT_BasePlayer", "m_viewPunchAngle");
	m_aimPunchAngle = Netvars->GetOffset("DT_BasePlayer", "m_aimPunchAngle");
	...
	// catch me with that sack, and a pile of yayo
	...
	InvalidateBoneCacheEx = Util::FindPattern("client.dll", "80 3D ? ? ? ? ? 74 16 A1 ? ? ? ? 48 C7 81");
