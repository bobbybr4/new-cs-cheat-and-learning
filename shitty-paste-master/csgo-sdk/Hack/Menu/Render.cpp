...
void CRender::Init(IDirect3DDevice9* pDevice)
{
	...
	*/
	//D3DXCreateFontA(this->device, 12/*size*/, 0, /*(bold) ? FW_BOLD : */FW_BOLD, 1, /*(italic) ? 1 : */0, ANSI_CHARSET, OUT_DEFAULT_PRECIS, CLEARTYPE_QUALITY, DEFAULT_PITCH, "Tahoma", &this->Fonts.esp);
	...
	D3DXCreateFontA(this->device, 12/*size*/, 0, 400, 1, /*(italic) ? 1 : */0, ANSI_CHARSET, OUT_DEFAULT_PRECIS, CLEARTYPE_QUALITY, DEFAULT_PITCH, "Tahoma", &this->Fonts.menu_control);
	D3DXCreateFontA(this->device, 25, 0, 400, 1, 0, ANSI_CHARSET, OUT_DEFAULT_PRECIS, CLEARTYPE_QUALITY, DEFAULT_PITCH, "tranquility", &this->Fonts.menu_icons);
	D3DXCreateFontA(this->device, 24, 0, 400, 1, 0, ANSI_CHARSET, OUT_DEFAULT_PRECIS, CLEARTYPE_QUALITY, DEFAULT_PITCH, "tranquility", &this->Fonts.weapon_icon); 
	return;
}
