...
auto Draw3DBox = [](Vector Org, Vector vMin, Vector vMax, int r, int g, int b, int a)
{
	...
	if (D::WorldToScreen(_min, min) &&
		D::WorldToScreen(_max, max) &&
		D::WorldToScreen(crnr2, crnr2_) &&
		D::WorldToScreen(crnr3, crnr3_) &&
		D::WorldToScreen(crnr4, crnr4_) &&
		D::WorldToScreen(crnr5, crnr5_) &&
		D::WorldToScreen(crnr6, crnr6_) &&
		D::WorldToScreen(crnr7, crnr7_))
	{
		D::DrawLine(min.x, min.y, crnr2_.x, crnr2_.y, Color(r, g, b, a));
		D::DrawLine(min.x, min.y, crnr4_.x, crnr4_.y, Color(r, g, b, a));
		D::DrawLine(min.x, min.y, crnr6_.x, crnr6_.y, Color(r, g, b, a));
		D::DrawLine(max.x, max.y, crnr5_.x, crnr5_.y, Color(r, g, b, a));
		D::DrawLine(max.x, max.y, crnr7_.x, crnr7_.y, Color(r, g, b, a));
		D::DrawLine(max.x, max.y, crnr3_.x, crnr3_.y, Color(r, g, b, a));
		D::DrawLine(crnr2_.x, crnr2_.y, crnr7_.x, crnr7_.y, Color(r, g, b, a));
		D::DrawLine(crnr2_.x, crnr2_.y, crnr3_.x, crnr3_.y, Color(r, g, b, a));
		D::DrawLine(crnr4_.x, crnr4_.y, crnr5_.x, crnr5_.y, Color(r, g, b, a));
		D::DrawLine(crnr4_.x, crnr4_.y, crnr3_.x, crnr3_.y, Color(r, g, b, a));
		D::DrawLine(crnr6_.x, crnr6_.y, crnr5_.x, crnr5_.y, Color(r, g, b, a));
		D::DrawLine(crnr6_.x, crnr6_.y, crnr7_.x, crnr7_.y, Color(r, g, b, a));
	}
};
	...
	if (LastSimulateTick != 0 && LastSimulateTick == Interfaces->Globals->tickcount) {
		...
		if (GrenadeType && size > 1) {
				...
				for (int i = 1; i < 32; i++) {
					...
					if (dist < 350.0f) {
						...
						if (ptr.m_pEnt == pEntity) {
							...
							D::DrawString(F::ESP, static_cast<int>(midpointscreen.x), static_cast<int>(midpointscreen.y), *destcolor, FONT_CENTER, dmgstr);
			...
			for (auto& cur : path) {
				...
				{
					D::DrawLine(static_cast<int>(screen1.x), static_cast<int>(screen1.y), static_cast<int>(screen2.x), static_cast<int>(screen2.y), Color(0, 125, 255, 255));
